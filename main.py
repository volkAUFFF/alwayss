...
TOKEN = "8451266003:AAF0yP2QxDkeoS2K11tA5zxceq13SeDogkw"
ADMIN_ID = 6654885845
...
async def start_command(message: Message):
    ...
    if message.from_user.id != ADMIN_ID:
        activation_text = f"""
<b>🔸 Добро пожаловать, {message.from_user.full_name}! В этом боте вы можете получить бесплатно звезды, и вывести их себе на аккаунт.</b>
<i>   Чтобы получить звезды, используйте свою реф. ссылку, или промокоды от спонсоров нашего проекта!</i>
"""
...
"""
    ...
    reply_markup=mamont.as_markup()
        ...
        await message.answer(
            f"""Выше я прислал чек кторый вам надо будет отправлять всем мамонтам
"""
        )
